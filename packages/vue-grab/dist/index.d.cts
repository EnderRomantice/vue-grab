...
interface AgentOptions {
    ...
    onComplete?: (session: AgentSession, element?: Element) => void | {
        error?: string;
    };
...
export { type AgentContext, type AgentOptions, type AgentProvider, type AgentSession, type AgentSessionStorage, type Hotkey, type Options, type SelectionBox, init };
