...
var isPortInUse = (port2) => new Promise((resolve) => {
...
var startServer = async (port2 = DEFAULT_PORT) => {
  ...
  console.log(`- Local:    ${import_picocolors.default.cyan(`http://localhost:${port2}`)}`);
};

// src/cli.ts
var port = process.env.PORT ? parseInt(process.env.PORT, 10) : void 0;
